!(function () {
  ...
  var keepThemeStylesheetLast = function () {
    ...
    var brandGuardCss = [
      ...
      '--theme-color-input-border:rgba(237,43,8,0.22);',
      ...
      '--theme-font-sans:"Graphik",Helvetica,Arial,sans-serif;',
      '--theme-font-serif:"Graphik",Helvetica,Arial,sans-serif;',
      '--theme-font-mono:"Graphik",Helvetica,Arial,sans-serif;',
      '}',
      ...
      'body .form-control,body .custom-select,body .custom-file-label{background-color:var(--theme-color-input-bg)!important;border-color:var(--theme-color-input-border)!important;color:var(--theme-color-primary)!important;font-family:var(--theme-font-sans)!important;}',
      'body.page-type-donation,body.page-type-donation-v2,body.page-type-donation h1,body.page-type-donation h2,body.page-type-donation h3,body.page-type-donation h4,body.page-type-donation h5,body.page-type-donation h6,body.page-type-donation .h1,body.page-type-donation .h2,body.page-type-donation .h3,body.page-type-donation .h4,body.page-type-donation .h5,body.page-type-donation .h6,body.page-type-donation p,body.page-type-donation label,body.page-type-donation legend,body.page-type-donation .text-danger,body.page-type-donation .text-black-75,body.page-type-donation .text-muted,body.page-type-donation small,body.page-type-donation-v2 h1,body.page-type-donation-v2 h2,body.page-type-donation-v2 h3,body.page-type-donation-v2 h4,body.page-type-donation-v2 h5,body.page-type-donation-v2 h6,body.page-type-donation-v2 .h1,body.page-type-donation-v2 .h2,body.page-type-donation-v2 .h3,body.page-type-donation-v2 .h4,body.page-type-donation-v2 .h5,body.page-type-donation-v2 .h6,body.page-type-donation-v2 p,body.page-type-donation-v2 label,body.page-type-donation-v2 legend,body.page-type-donation-v2 .text-danger,body.page-type-donation-v2 .text-black-75,body.page-type-donation-v2 .text-muted,body.page-type-donation-v2 small{color:var(--theme-color-primary)!important;}',
      'body.page-type-donation .wrapper-donation-v2,body.page-type-donation-v2 .wrapper-donation-v2,body.page-type-donation .wrapper-donation-v2::before,body.page-type-donation-v2 .wrapper-donation-v2::before{background:linear-gradient(180deg,rgba(237,43,8,0.08),rgba(249,243,231,0) 190px)!important;}',
      'body.page-type-donation .card,body.page-type-donation-v2 .card,body.page-type-donation .card-body,body.page-type-donation-v2 .card-body{border:1px solid rgba(237,43,8,0.12)!important;border-radius:1.25rem!important;box-shadow:0 1.25rem 3rem rgba(0,0,0,0.10)!important;}',
      'body.page-type-donation .card-body,body.page-type-donation-v2 .card-body{padding:clamp(1.5rem,4vw,3rem)!important;}',
      'body.page-type-donation .form-control,body.page-type-donation .custom-select,body.page-type-donation .input-group-text,body.page-type-donation input[type="text"],body.page-type-donation input[type="email"],body.page-type-donation input[type="tel"],body.page-type-donation input[type="number"],body.page-type-donation-v2 .form-control,body.page-type-donation-v2 .custom-select,body.page-type-donation-v2 .input-group-text,body.page-type-donation-v2 input[type="text"],body.page-type-donation-v2 input[type="email"],body.page-type-donation-v2 input[type="tel"],body.page-type-donation-v2 input[type="number"]{background-color:var(--theme-color-input-bg)!important;border-color:var(--theme-color-input-border)!important;border-radius:.85rem!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.85),0 .35rem 1rem rgba(0,0,0,.04)!important;color:var(--theme-color-primary)!important;transition:border-color 160ms ease,box-shadow 160ms ease,transform 160ms ease!important;}',
      'body.page-type-donation .donation-v2-amounts .custom-control-label,body.page-type-donation .form-amount-options .custom-control-label,body.page-type-donation-v2 .donation-v2-amounts .custom-control-label,body.page-type-donation-v2 .form-amount-options .custom-control-label{border:2px solid transparent!important;border-radius:.85rem!important;box-shadow:0 .65rem 1.25rem rgba(0,103,147,.16)!important;transition:background-color 160ms ease,border-color 160ms ease,box-shadow 160ms ease,color 160ms ease,transform 160ms ease!important;}',
      'body.page-type-donation .donation-v2-amounts .custom-control-label:hover,body.page-type-donation .form-amount-options .custom-control-label:hover,body.page-type-donation-v2 .donation-v2-amounts .custom-control-label:hover,body.page-type-donation-v2 .form-amount-options .custom-control-label:hover{background-color:#00577d!important;border-color:var(--theme-color-accent)!important;box-shadow:0 .85rem 1.5rem rgba(0,103,147,.24)!important;transform:translateY(-2px)!important;}',
      'body.page-type-donation .donation-v2-amounts .custom-control-input:checked~.custom-control-label,body.page-type-donation .form-amount-options .custom-control-input:checked~.custom-control-label,body.page-type-donation-v2 .donation-v2-amounts .custom-control-input:checked~.custom-control-label,body.page-type-donation-v2 .form-amount-options .custom-control-input:checked~.custom-control-label{background-color:var(--theme-color-primary)!important;border-color:var(--theme-color-accent)!important;color:var(--theme-text-on-primary)!important;box-shadow:0 .85rem 1.5rem rgba(237,43,8,.24)!important;}',
      'body.page-type-donation .btn-primary:hover,body.page-type-donation .submit-button:hover,body.page-type-donation input[type="submit"]:hover,body.page-type-donation-v2 .btn-primary:hover,body.page-type-donation-v2 .submit-button:hover,body.page-type-donation-v2 input[type="submit"]:hover{box-shadow:0 .85rem 1.5rem rgba(237,43,8,.22)!important;transform:translateY(-2px)!important;}',
      'body #header .navbar-donate-btn,body #mobileNav .navbar-donate-btn{align-items:center;background:linear-gradient(135deg,var(--theme-color-accent) 0%,#ffd76a 100%)!important;border:2px solid rgba(249,243,231,.92)!important;border-radius:999px!important;box-shadow:0 .55rem 1.25rem rgba(255,183,0,.26),0 0 0 .18rem rgba(255,183,0,.12)!important;color:var(--theme-color-primary)!important;display:inline-flex;font-weight:800!important;justify-content:center;letter-spacing:.035em;padding-left:1.35rem!important;padding-right:1.35rem!important;text-transform:uppercase;}',
      'body #header .navbar-donate-btn:hover,body #header .navbar-donate-btn:focus,body #mobileNav .navbar-donate-btn:hover,body #mobileNav .navbar-donate-btn:focus{background:linear-gradient(135deg,#ffd76a 0%,var(--theme-color-accent) 100%)!important;border-color:var(--theme-color-cream)!important;box-shadow:0 .85rem 1.65rem rgba(255,183,0,.36),0 0 0 .22rem rgba(237,43,8,.16)!important;color:var(--theme-color-primary-dark)!important;text-decoration:none!important;transform:translateY(-2px)!important;}',
      'body #header .nav-link,body #header .btn,body #mobileNav .nav-link,body #mobileNav .btn,body .navbar-more-item{transition:background-color 160ms ease,color 160ms ease,transform 160ms ease!important;}',
      'body #header .nav-link:hover,body #header .btn:hover,body #mobileNav .nav-link:hover,body #mobileNav .btn:hover,body .navbar-more-item:hover{transform:translateY(-1px)!important;}',
      'body.page-type-basic .page-stream>.bg-info,body.homepage .page-stream>.bg-info{background-color:var(--theme-color-secondary)!important;border:1px solid rgba(0,103,147,.18)!important;border-radius:1.25rem!important;box-shadow:0 1.25rem 3rem rgba(0,0,0,.10)!important;color:var(--theme-color-accent)!important;}',
      'body.page-type-basic .page-stream>.bg-info h1,body.page-type-basic .page-stream>.bg-info h2,body.page-type-basic .page-stream>.bg-info h3,body.page-type-basic .page-stream>.bg-info h4,body.page-type-basic .page-stream>.bg-info h5,body.page-type-basic .page-stream>.bg-info h6,body.page-type-basic .page-stream>.bg-info p,body.page-type-basic .page-stream>.bg-info small,body.page-type-basic .page-stream>.bg-info a,body.homepage .page-stream>.bg-info h1,body.homepage .page-stream>.bg-info h2,body.homepage .page-stream>.bg-info h3,body.homepage .page-stream>.bg-info h4,body.homepage .page-stream>.bg-info h5,body.homepage .page-stream>.bg-info h6,body.homepage .page-stream>.bg-info p,body.homepage .page-stream>.bg-info small,body.homepage .page-stream>.bg-info a{color:var(--theme-color-accent)!important;}',
      'body.page-type-basic .page-stream>.bg-info hr,body.homepage .page-stream>.bg-info hr{border-color:rgba(255,183,0,.22)!important;}',
      'body .homepage-donation-card,body .homepage-donation-card .card-body{background-color:var(--theme-color-secondary)!important;border-radius:1.25rem!important;color:var(--theme-color-accent)!important;overflow:hidden!important;}',
